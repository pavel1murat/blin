...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef Stntuple_ana_TMyTrackAnaModule_hh
#define Stntuple_ana_TMyTrackAnaModule_hh
...
class TMyTrackAnaModule: public TStnModule {
public:
...
//-----------------------------------------------------------------------------
public:
  TMyTrackAnaModule(const char* name="MyTrackAna", const char* title="MyTrackAna");
  ~TMyTrackAnaModule();
//-----------------------------------------------------------------------------
// accessors
//-----------------------------------------------------------------------------
